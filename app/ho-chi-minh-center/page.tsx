...
export default function HCMCenterPage() {
  return (
      ...
      <section className="relative mt-16 flex w-full flex-col md:mt-0">
        ...
        <div className="relative z-0 h-[50vh] min-h-[400px] w-full md:h-[65vh] md:min-h-[550px]">
          <Image
            ...
            alt="Ho Chi Minh City Yoga Center"
            fill
        ...
        <div className="relative z-10 mx-auto w-[95%] max-w-5xl bg-[#FDFCF8] px-6 pb-6 pt-10 text-center -mt-16 md:-mt-24 md:pb-12 md:pt-16">
          ...
          <p className="mx-auto max-w-3xl leading-relaxed text-[#4A4A4A] md:text-lg">
            Escape the hustle and bustle of Saigon. Step into our serene city
            center to recharge your energy, find inner stillness, and connect
            with a vibrant community of spiritual seekers.
          </p>
        </div>
      </section>
        ...
        <div className="flex flex-col items-center gap-12 md:flex-row-reverse lg:gap-20">
          ...
          <div className="w-full space-y-6 md:w-1/2">
            ...
            <div className="space-y-4 pt-4 text-base leading-relaxed text-[#4A4A4A] md:text-lg">
              <p>
                Located in the heart of Ho Chi Minh City, our center is a
                dedicated space for the practice and study of classical Yoga and
                Vedanta. We offer a welcoming environment for both beginners and
                experienced practitioners.
              </p>
              <p>
                Whether you have an hour before work, a lunch break, or an
                evening to unwind, our schedule is designed to fit the urban
                lifestyle while maintaining the purity and discipline of
                traditional teachings.
              </p>
              <p>
                Join our daily open classes, structured beginner courses, or
                weekly Satsangs (meditation and chanting gatherings) to elevate
                your mind and maintain physical health amidst city life.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="w-full space-y-8 md:w-1/2">
            <div>
              ...
              <p className="leading-relaxed text-[#4A4A4A]">
                We are conveniently located in District 1, providing a tranquil
                escape easily accessible from anywhere in the city.
              </p>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-bold text-[#0B3B24]">
                    Sivananda Yoga Center Ho Chi Minh City
                  </p>
                  <p>
                    25 Tran Quy Khoach Street, Tan Dinh Ward
                    <br />
