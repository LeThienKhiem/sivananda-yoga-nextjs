...
export default function DalatCityCenterPage() {
  return (
    <main className="flex min-h-screen flex-col bg-[#FDFCF8]">
      ...
      <section className="relative mt-16 flex w-full flex-col md:mt-0">
        ...
        <div className="relative z-0 h-[50vh] min-h-[400px] w-full md:h-[65vh] md:min-h-[550px]">
          <Image
            src="https://images.unsplash.com/photo-1599901860904-17e0862211ea?q=80&w=2000"
            alt="Sivananda Yoga Dalat Center"
            fill
        ...
        <div className="relative z-10 mx-auto w-[95%] max-w-5xl bg-[#FDFCF8] px-6 pb-6 pt-10 text-center -mt-16 md:-mt-24 md:pb-12 md:pt-16">
          ...
          <p className="mx-auto max-w-3xl leading-relaxed text-[#4A4A4A] md:text-lg">
            Experience the crisp mountain air and a warm community right in the
            heart of Dalat. A convenient, peaceful space dedicated to classical
            Yoga teachings and holistic well-being.
          </p>
        </div>
      </section>
        ...
        <div className="flex flex-col items-center gap-12 md:flex-row-reverse lg:gap-20">
          ...
          <div className="w-full space-y-6 md:w-1/2">
            <h2 className="font-serif text-3xl font-bold text-[#0B3B24] md:text-4xl">
              Find Balance in the City of Flowers
            </h2>
            <div className="h-1 w-16 bg-[#ED7D4D]" />
            <div className="space-y-4 pt-4 text-base leading-relaxed text-[#4A4A4A] md:text-lg">
              <p>
                While our main Ashram offers a deep retreat in nature, our Dalat
                City Center provides an accessible sanctuary for locals and
                travelers staying in town.
              </p>
              <p>
                We believe that yoga should be integrated into your daily
                routine. Our schedule is designed to help you recharge your body
                and calm your mind, whether you are starting your morning or
      ...
      <section className="mx-auto w-full max-w-[1600px] px-6 py-28 md:py-32">
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-16 px-6 md:flex-row">
          ...
          <div className="w-full space-y-8 md:w-1/2">
            <div>
              ...
              <p className="leading-relaxed text-[#4A4A4A]">
                Conveniently located in Dalat city, easily accessible for
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="font-bold text-[#0B3B24]">
                    Sivananda Yoga Center Dalat City
                  </p>
                  <p>
                    14 Phan Dinh Phung Street, Ward 1
                    <br />
                    Dalat City, Lam Dong, Vietnam
                  </p>
                </div>
              </div>
          ...
          <div className="w-full md:w-1/2">
            <div className="relative flex min-h-[300px] w-full items-center justify-center overflow-hidden rounded-sm border border-gray-300 bg-gray-200 shadow-inner">
              ...
              />
              <div className="relative flex flex-col items-center rounded-full bg-white p-4 shadow-lg text-center text-[#0B3B24]">
